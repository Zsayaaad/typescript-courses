...
let lowNumber: OneThroughFive = 4 //✔️ Valid
...
let evenOrLowNumber1 = 9 as Evens | OneThroughFive
let evenOrLowNumber2: Evens | OneThroughFive = 9

type AllNumbersStrings = number | string
let rr: AllNumbersStrings = 'sdf'
rr = 5
