...
// humidity = 78 //! re-assignability of a const
...
let endTime: Date // explicit type annotation
...
let date2 = frontEndMastersFounding as Date
...
result.toExponential() //! what do we think will happen when we run this?👉 💥
